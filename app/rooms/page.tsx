      ...
      <section className="relative h-[50vh] flex items-center justify-center">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Comfortable hotel rooms at Hotel Izvor Serbia showcasing elegant design and mountain views"
            fill
                  ...
                  >
                    ...
                    <div className={`${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                      <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                        <Image
                          src={room.image}
                          alt={`${roomData.name} at Hotel Izvor Serbia - main view showcasing room layout and mountain views`}
                          fill
                          className="object-cover"
                        />
                      </div>
                      <div className="grid grid-cols-3 gap-4 mt-4">
                        {room.gallery.map((img, idx) => (
                          <div key={idx} className="relative h-32 rounded-lg overflow-hidden shadow-lg">
                            <Image
                              src={img}
                              alt={`${roomData.name} Hotel Izvor - detailed view ${idx + 1} showing interior features and comfortable design`}
                              fill
