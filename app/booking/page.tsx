    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-800 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl">{t.booking.subtitle || 'Complete your reservation at Hotel Izvor Aranđelovac'}</p>
        </div>
      </div>
                        ...
                        return (
                          ...
                          >
                            <div className="relative h-32 mb-3 rounded-lg overflow-hidden">
                              <Image src={room.image} alt={`${roomTranslation?.name || room.name} at Hotel Izvor Serbia - accommodation option`} fill className="object-cover" />
                            </div>
                ...
                <div>
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex items-center space-x-2">
                      <Image src="https://upload.wikimedia.org/wikipedia/commons/0/04/Visa.svg" alt="Visa credit card payment accepted at Hotel Izvor" width={50} height={32} className="h-8" />
                ...
                <div className="mb-6">
                  <div className="relative h-40 rounded-lg overflow-hidden mb-3">
                    <Image
                      ...
                      alt={`${roomsInfo[selectedRoom].name} at Hotel Izvor - selected room for booking`}
                      fill
