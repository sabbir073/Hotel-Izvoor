      ...
      <section className="relative h-[50vh] flex items-center justify-center">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Contact Hotel Izvor d.o.o. Aranđelovac Serbia - friendly staff ready to assist with your wellness retreat"
            fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Mišarska BB, 34300<br />Aranđelovac, Serbia</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+381000000000" className="hover:text-primary-600 transition-colors block">
                        +381 00 000 0000
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:info@hotelizvordoo.com" className="hover:text-primary-600 transition-colors">
              ...
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-lg">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2889.8!2d20.5564!3d44.3089!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zQXJhbsSRZWxvdmFjLCBTZXJiaWE!5e0!3m2!1sen!2s!4v1234567890"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="Hotel Izvor d.o.o. Location"
                ></iframe>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <a href="mailto:info@hotelizvordoo.com" className="text-primary-600 hover:text-primary-700 font-medium">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <a href="mailto:events@hotelizvordoo.com" className="text-primary-600 hover:text-primary-700 font-medium">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <a href="mailto:concierge@hotelizvordoo.com" className="text-primary-600 hover:text-primary-700 font-medium">
