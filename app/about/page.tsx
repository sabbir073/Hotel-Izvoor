      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        <div className="absolute inset-0">
          <Image
            ...
            alt="About Hotel Izvor d.o.o. Aranđelovac Serbia - premium wellness resort with natural beauty and exceptional hospitality"
            fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Beautiful architecture and natural surroundings of Hotel Izvor showcasing Serbian mountain wellness resort"
                fill
                className="object-cover"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="relative w-48 h-48 mx-auto mb-4 rounded-full overflow-hidden">
                <Image
                  ...
                  alt="Director of Hotel Izvor d.o.o. - experienced hospitality leader"
                  fill
                  className="object-cover"
                />
              </div>
            ...
            <div className="text-center">
              <div className="relative w-48 h-48 mx-auto mb-4 rounded-full overflow-hidden">
                <Image
                  ...
                  alt="General Manager at Hotel Izvor - dedicated to exceptional guest service and hospitality excellence"
                  fill
                  className="object-cover"
                />
              </div>
            ...
            <div className="text-center">
              <div className="relative w-48 h-48 mx-auto mb-4 rounded-full overflow-hidden">
                <Image
                  src="/images/team/team-1.webp"
                  alt="Spa & Wellness Director at Hotel Izvor - ensuring smooth operations and guest wellness"
                  fill
                  className="object-cover"
                />
              </div>
            ...
            <div className="text-center">
              <div className="relative w-48 h-48 mx-auto mb-4 rounded-full overflow-hidden">
                <Image
                  ...
                  alt="Executive Chef at Hotel Izvor - culinary expert creating exceptional Serbian and international cuisine"
                  fill
                  className="object-cover"
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <div className="flex items-start">
                    <span className="font-semibold text-gray-800 w-32 flex-shrink-0">{t.about.companyInfo.activityLabel}:</span>
                    <span className="text-gray-600">{t.about.companyInfo.activity}</span>
                  </div>
                  <div className="flex items-start">
                    <span className="font-semibold text-gray-800 w-32 flex-shrink-0">{t.about.companyInfo.addressLabel}:</span>
                    <span className="text-gray-600">{t.about.companyInfo.address}</span>
                  </div>
                  <div className="flex items-start">
                    <span className="font-semibold text-gray-800 w-32 flex-shrink-0">{t.about.companyInfo.contactLabel}:</span>
                    <span className="text-gray-600">{t.about.companyInfo.contact}</span>
                  </div>
                </div>

                <div className="space-y-3">
                  <div className="flex items-start">
                    <span className="font-semibold text-gray-800 w-32 flex-shrink-0">PIB:</span>
                    <span className="text-gray-600">102705684</span>
                  </div>
                  <div className="flex items-start">
                    <span className="font-semibold text-gray-800 w-32 flex-shrink-0">MB:</span>
                    <span className="text-gray-600">17772503</span>
                  </div>
                  <div className="flex items-start">
                    <span className="font-semibold text-gray-800 w-32 flex-shrink-0">{t.about.companyInfo.establishedLabel}:</span>
                    <span className="text-gray-600">{t.about.companyInfo.established}</span>
                  </div>
                </div>
              </div>
            </div>
